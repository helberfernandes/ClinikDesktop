...
public class FrmRelQTDProcedimentoPorExames extends JInternalFrame implements Observer {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmRelQTDProcedimentoPorExames frame = new FrmRelQTDProcedimentoPorExames();
  ...
  /*
	 ...
	 * Create the frame.
	 */
	public FrmRelQTDProcedimentoPorExames() {
		setTitle("QTD. Procedimentos por Exames");
		...
		btnPesquisar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				relatorioUtil.ImprimirRelatorio(Configuracao.REL_QTD_PROCEDIMENTOS_POR_EXAMES, parametros);
