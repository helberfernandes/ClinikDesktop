...
public class FrmRelQTDProcedimentosPeloDRJuan extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmRelQTDProcedimentosPeloDRJuan frame = new FrmRelQTDProcedimentosPeloDRJuan();
	 ...
	 * Create the frame.
	 */
	public FrmRelQTDProcedimentosPeloDRJuan() {
		setTitle("QTD. Procedimentos Pelo Dr. Juan");
		...
		btnPesquisar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				relatorioUtil.ImprimirRelatorio(Configuracao.REL_QTD_PROCEDIMENTOS_PELO_DR_JUAN, parametros);
