package br.com.wofsolutions.gui;
	...
	public class FrmRelQTDProcedimentosPeloDRKalil extends JInternalFrame {
		...
		public static void main(String[] args) {
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						FrmRelQTDProcedimentosPeloDRKalil frame = new FrmRelQTDProcedimentosPeloDRKalil();
		 ...
		 * Create the frame.
		 */
		public FrmRelQTDProcedimentosPeloDRKalil() {
			setTitle("QTD. Procedimentos Pelo Dr. Kalil");
			...
			btnPesquisar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					relatorioUtil.ImprimirRelatorio(Configuracao.REL_QTD_PROCEDIMENTOS_PELO_DR_KALIL, parametros);
